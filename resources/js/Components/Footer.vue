        ...
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="flex items-center mb-6">
                        <span class="text-3xl font-bold text-white">🛍️ E-Commerce</span>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <Link href="/shop" class="text-gray-400 hover:text-white transition-colors">
                                🛒 Boutique
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link href="/offers" class="text-gray-400 hover:text-white transition-colors">
                                🎁 Offres
                            </Link>
                        </li>
                    </ul>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <Link href="/categories/mode" class="text-gray-400 hover:text-white transition-colors">
                                👗 Mode & Accessoires
                            </Link>
                        </li>
                        <li>
                            <Link href="/categories/electronique" class="text-gray-400 hover:text-white transition-colors">
                                📱 Électronique
                            </Link>
                        </li>
                        <li>
                            <Link href="/categories/maison" class="text-gray-400 hover:text-white transition-colors">
                                🏠 Maison & Jardin
                            </Link>
                        </li>
                        <li>
                            <Link href="/categories/sport" class="text-gray-400 hover:text-white transition-colors">
                                ⚽ Sport & Loisirs
                            </Link>
                        </li>
                        <li>
                            <Link href="/categories/beaute" class="text-gray-400 hover:text-white transition-colors">
                                💄 Beauté & Santé
                            </Link>
                        </li>
                    </ul>
                ...
                <!-- Customer Service -->
                <div>
                    <h3 class="text-lg font-semibold mb-6">Service Client</h3>
                    <ul class="space-y-3">
                        <li>
                        ...
                        <li>
                            <Link href="/shipping" class="text-gray-400 hover:text-white transition-colors">
                                🚚 Livraison
                            </Link>
                        </li>
                        <li>
                            <Link href="/returns" class="text-gray-400 hover:text-white transition-colors">
                                🔄 Retours
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link href="/support" class="text-gray-400 hover:text-white transition-colors">
                                🛠️ Support technique
                            </Link>
                        </li>
                    </ul>
            ...
            <div class="mt-16 pt-8 border-t border-gray-800">
                <div class="max-w-md mx-auto text-center">
                    <h3 class="text-xl font-semibold mb-4">Restez informé !</h3>
                    <p class="text-gray-400 mb-6">
                        Recevez nos dernières offres et nouveautés en vous inscrivant à notre newsletter.
                    </p>
